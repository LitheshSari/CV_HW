...
public:
    ...
    Kalman(Matrix_xxd A, Matrix_zxd H, Matrix_xxd R, Matrix_zzd Q, Matrix_x1d init)
    {
        reset(A, H, R, Q, init);
    }

    void reset(Matrix_xxd A, Matrix_zxd H, Matrix_xxd R, Matrix_zzd Q, Matrix_x1d init)
    {
        this->A = A;
        this->H = H;
    ...
    Matrix_x1d update(Matrix_z1d z_k)
    {
        // 预测下一时刻的值
